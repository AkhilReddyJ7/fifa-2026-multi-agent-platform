...
TEAMS = [
    ...
    {"name": "USA", "fifa_code": "USA", "confederation": "CONCACAF", "elo_rating": 1830.0},
    ...
    # Co-hosts
    {"name": "United States", "fifa_code": "US2", "confederation": "CONCACAF", "elo_rating": 1830.0},
]
...
MATCHES_2022 = [
    ...
    # Third place
    {"home": "CRO", "away": "MAR", "stage": "3rd", "home_g": 2, "away_g": 1, "year": 2022, "venue": "Khalifa International Stadium"},
]
...
async def seed_rag() -> None:
    try:
        from app.rag.ingestion import ingest_wc_history
        ingest_wc_history()
